...
import { Hourglass, Clock, CheckCircle, AlertTriangle, Info } from 'lucide-react';
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-5 w-5 ml-1" onClick={() => onShowDetails(building)}>
