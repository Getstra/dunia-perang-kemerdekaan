    ...
    <div className="md:col-span-3">
      <div className={`glass-card ${theme}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                {battleTargets.map((target) => (
                  <div
                    key={target.id}
                    className="p-3 glass-panel rounded-md cursor-pointer hover:bg-amber-900/20"
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs ${getThreatColor(target.threat)}`}
                          >
                            {target.threat}
                          </span>
                        </div>
          ...
          <div className="p-4 glass-panel rounded-md md:col-span-2">
            <h3 className="font-semibold text-lg mb-2 flex items-center">
            ...
            <div className="space-y-3">
              <div className="p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Alliances provide military benefits and protection.
                </p>
              </div>
              ...
              <div className="p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Build an Embassy to form alliances with other kingdoms.
                </p>
              </div>
          ...
          <div className="py-4">
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  You need to build a Barracks (Level 1) before you can train
                  military units.
                </p>
              </div>
            </div>
        ...
        <DialogContent className="sm:max-w-[500px] glass-dialog">
          ...
          <div className="py-4">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {battleTargets.map((target) => (
                  <div key={target.id} className="p-3 glass-panel rounded-md">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <p className="text-xs text-green-600 mt-1">
                          Potential reward: {target.reward}
                        </p>
                      </div>
                      <div>
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                <p className="text-sm font-medium">Requirements</p>
                <p className="text-xs text-muted-foreground mt-1">
                  You need to have at least 10 military units and a Watchtower
                  (Level 1) before you can plan battles.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="p-3 glass-panel rounded-md">
                  <p className="font-medium text-lg">
                    {battleTargets.find((t) => t.id === selectedTarget)?.name}
                  </p>
                  <div className="grid grid-cols-2 gap-4 mt-2">
                    <div>
                      ...
                      <p className="text-lg font-bold text-amber-600">
                        {
                          battleTargets.find((t) => t.id === selectedTarget)
                            ?.strength
                        }
                      </p>
                    </div>
                    <div>
                      ...
                      <p
                        className={`text-lg font-bold ${getThreatColor(battleTargets.find((t) => t.id === selectedTarget)?.threat || "")}`}
                      >
                        {
                          battleTargets.find((t) => t.id === selectedTarget)
                            ?.threat
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={() => setShowAttackDetailsDialog(false)}
                    variant="outline"
                    className="flex-1"
                  >
                    Cancel
