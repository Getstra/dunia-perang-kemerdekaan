...
const DiplomacyTab: React.FC = () => {
  ...
  const allianceOptions = [
    {
      id: 1,
      name: "Eastdale",
      benefits: ["Mutual Defense", "Open Borders"],
      requirements: "70+ Relations",
      relationLevel: 50,
    },
    {
      id: 2,
      name: "Southern Isles",
      benefits: ["Resource Sharing", "Military Support"],
      requirements: "80+ Relations",
      relationLevel: 75,
    },
  ];
  ...
  const tradeOptions = [
    ...
    },
    {
      id: 2,
      name: "Southern Isles",
      offers: "Exotic Goods, Fish",
      wants: "Iron, Gold",
      profit: "+25 Gold/day",
    },
    {
      id: 3,
      name: "Western Dominion",
      offers: "Iron, Gems",
      wants: "Food, Wood",
      profit: "+35 Gold/day",
    },
            ...
            <div className="p-3 glass-panel rounded-md">
              ...
              <p className="text-xs text-muted-foreground">
                {activeAlliances.length > 0
                  ? `${activeAlliances.length} formal alliances established`
                  : "No formal alliances established"}
              </p>
            </div>
            <div className="p-3 glass-panel rounded-md">
              <p className="text-sm font-semibold">Trade Income</p>
              <p className="text-2xl font-bold text-amber-600">
                {activeTradeRoutes.length > 0 ? "+75" : "0"}
              </p>
              <p className="text-xs text-muted-foreground">
                {activeTradeRoutes.length > 0
                  ? `${activeTradeRoutes.length} active trade routes`
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                {relations.map((kingdom) => (
                  <div
                    key={kingdom.id}
                    className={`p-3 glass-panel rounded-md cursor-pointer transition-all ${selectedKingdom === kingdom.id ? "bg-amber-900/20" : "hover:bg-amber-900/10"}`}
                  ...
                  >
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="flex items-center">
                          ...
                          {kingdom.status === "Friendly" && (
                            <span className="ml-1 text-xs bg-green-600/20 text-green-700 px-1 rounded">
                              +5 relation/day
                            </span>
                          )}
                          {kingdom.status === "Hostile" && (
                            <span className="ml-1 text-xs bg-red-600/20 text-red-700 px-1 rounded">
                              -3 relation/day
                            </span>
                          )}
                        </div>
                      ...
                      <div className="text-right">
                        ...
                        <p
                          className={`text-sm ${getRelationColor(kingdom.relationLevel)}`}
                        >
                          {kingdom.relationLevel}/100
                        </p>
                        <Progress
                          value={kingdom.relationLevel}
            ...
            <div className="space-y-3">
              <div className="p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Establish trade routes to generate passive income.
                </p>
              </div>
              ...
              <div className="p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Build a Trading Post to establish trade routes with other
                  kingdoms.
                </p>
              </div>
          ...
          <div className="py-4">
            <div className="space-y-4">
                  ...
                  <div key={option.id} className="p-3 glass-panel rounded-md">
                    ...
                    <div className="mt-2">
                      <p className="text-xs font-medium">
                        Current Relations: {option.relationLevel}/100
                      </p>
                      <Progress
                        value={option.relationLevel}
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  You need to build an Embassy (Level 1) before you can form
                  alliances.
                </p>
              </div>
            </div>
          ...
          <div className="py-4">
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                <p className="text-sm font-medium">Requirements</p>
                <p className="text-xs text-muted-foreground mt-1">
                  You need to build a Trading Post (Level 1) before you can
