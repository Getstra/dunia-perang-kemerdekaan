...
const LandTab: React.FC = () => {
  ...
  const totalLand = territories.reduce(
    (acc, territory) => acc + territory.size,
    0,
  );
  const totalExplored = territories.reduce(
    (acc, territory) => acc + (territory.size * territory.explored) / 100,
    0,
  );
  ...
  return (
    <div className="md:col-span-3">
      <div className={`glass-card ${theme}`}>
        ...
        <div className="mb-6 glass-panel rounded-md p-4">
          <h3 className="font-semibold text-lg mb-2 flex items-center">
            <Compass className="w-4 h-4 mr-2 text-amber-600" /> Territory
            Overview
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-3 glass-panel rounded-md">
              ...
              <p className="text-2xl font-bold text-amber-600">
                {Math.round(totalExplored)} acres
              </p>
              <div className="flex items-center text-xs text-muted-foreground">
                <span className="mr-2">
                  {explorationPercentage}% of total land
                </span>
                {explorationStats.explorers > 0 && (
                  <span className="text-green-600">
                    +{explorationStats.explorationSpeed}%/day
                  </span>
                )}
              </div>
            </div>
        ...
        <Tabs defaultValue="territories" className="w-full">
          ...
          <TabsContent value="territories" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 glass-panel rounded-md">
                <h3 className="font-semibold text-lg mb-2 flex items-center">
                  <Trees className="w-4 h-4 mr-2 text-amber-600" /> Your
                  Territories
                </h3>
                ...
                <div className="space-y-3">
                  {territories.map((territory) => (
                    <div
                      key={territory.id}
                      className={`p-3 glass-panel rounded-md cursor-pointer transition-colors ${
                    ...
                    >
                      <div className="flex justify-between">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            {territory.type} • {territory.size} acres
                          </p>
                        </div>
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {territory.resources.map((resource, i) => (
                                  <span
                                    key={i}
                                    className="text-xs bg-amber-900/20 px-1.5 py-0.5 rounded"
                                  >
                                    {resource}
                                  </span>
                                ))}
                            ...
                            <div>
                              ...
                              <div className="flex flex-wrap gap-1 mt-1">
                                {territory.special.map((special, i) => (
                                  <span
                                    key={i}
                                    className="text-xs bg-purple-600/20 text-purple-700 px-1.5 py-0.5 rounded"
                                  >
                                    {special}
                                  </span>
                                ))}
                ...
                <div className="space-y-3">
                  <div className="p-3 glass-panel rounded-md">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Build a Watchtower to expand your territory.
                    </p>
                  </div>

                  <div className="p-3 glass-panel rounded-md">
                    <p className="text-sm">
                      Expand your kingdom by claiming new territories.
                    </p>
          ...
          <TabsContent value="resources" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 glass-panel rounded-md">
                <h3 className="font-semibold text-lg mb-2 flex items-center">
                  <Pickaxe className="w-4 h-4 mr-2 text-amber-600" /> Found
                  Resources
                </h3>
                <p className="text-sm text-muted-foreground mb-4">
                  ...
                  {territories.map(
                    (territory) =>
                      territory.resources.length > 0 && (
                        <div
                          key={territory.id}
                          className="p-3 glass-panel rounded-md"
                        >
                          <p className="font-medium">{territory.name}</p>
                          <div className="flex flex-wrap gap-1 mt-1">
                            {territory.resources.map((resource, i) => (
                ...
                {territories.every((t) => t.resources.length === 0) && (
                  <div className="p-3 glass-panel rounded-md">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Explore territories to find resources.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="p-4 glass-panel rounded-md">
                <h3 className="font-semibold text-lg mb-2 flex items-center">
                  <Shovel className="w-4 h-4 mr-2 text-amber-600" /> Resource
                  Guide
                </h3>
                <p className="text-sm text-muted-foreground mb-4">
                ...
                <div className="space-y-2">
                  {possibleResources.map((resource, index) => (
                    <div key={index} className="p-3 glass-panel rounded-md">
                      <div className="flex justify-between">
                        <div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {expansionOptions.map((option) => (
                  <div key={option.id} className="p-3 glass-panel rounded-md">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-xs">
                              Resources: {option.resourcePotential}
                            </span>
                          </div>
                        </div>
                      </div>
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  You need to build a Watchtower (Level 1) before you can expand
                  your territory.
                </p>
              </div>
            </div>
      ...
      {/* Exploration Dialog */}
      <Dialog
        open={showExplorationDialog}
        onOpenChange={setShowExplorationDialog}
      >
        <DialogContent className="sm:max-w-[500px] glass-dialog">
          <DialogHeader>
          ...
          <div className="py-4">
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 glass-panel rounded-md">
                <p className="text-sm font-medium">Requirements</p>
                <p className="text-xs text-muted-foreground mt-1">
                  You need to train explorers in the Population tab before you
          ...
          <DialogFooter>
            <Button onClick={() => setShowExplorationDialog(false)}>
              Close
            </Button>
          </DialogFooter>
        </DialogContent>
