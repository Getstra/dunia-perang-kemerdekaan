...
import { Castle, Crown, Calendar, MapPin, Users, CoinsIcon } from "lucide-react";
...
const KingdomDetails: React.FC<KingdomDetailsProps> = ({ kingdom, resources }) => {
  ...
  const populationDensity = resources.land > 0 
        ...
        <div className="p-4 border border-amber-800/30 bg-amber-900/10 rounded-md">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium">{new Date(kingdom.lastUpdated).toLocaleString()}</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border border-amber-800/30 bg-amber-900/10 rounded-md">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">{resources.population} citizens</span>
            </div>
