...
const KingdomCreate: React.FC<KingdomCreateProps> = ({ onCreateKingdom }) => {
  ...
  return (
    <div className="glass-card max-w-md mx-auto my-10">
      <h2 className="medieval-heading text-2xl mb-4 text-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="flex">
            <div className="glass-panel p-2 border-r-0 rounded-l-sm">
            ...
            <input
              ...
              className="flex-1 p-2 glass-input rounded-r-sm focus:outline-none focus:ring-1 focus:ring-royal-blue"
        ...
        <button type="submit" className="w-full glass-button py-2 text-center">
          Establish Kingdom
        </button>
      </form>
      ...
      <div className="mt-6 text-sm text-center text-muted-foreground">
        ...
        <p>
          Lead your kingdom to greatness through strategic planning and wise
          management.
        </p>
      </div>
    </div>
